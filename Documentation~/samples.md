...
| [XR Mouse Interaction Demo](samples-xr-mouse-interaction-demo.md) | Demonstrates Android Mouse input support using the Android Mouse OpenXR Extension. |
...
| [XR Interaction Simulator](samples-xr-interaction-simulator.md) | Assets related to the simulation of input for XR headsets, controllers, and hands. This sample provides a simplified interface for simulation such as point-and-click. |
| [XR Device Simulator (Legacy)](samples-xr-device-simulator.md) | (Legacy) Assets related to the simulation of input for XR headsets, controllers, and hands. This is the older "classic" version of the simulator that existed before the XR Interaction Simulator sample was introduced and lacks many of the newer features such as point-and-click interactions. |
