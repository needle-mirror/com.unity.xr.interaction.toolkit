...
namespace UnityEditor.XR.Interaction.Toolkit.Interactors
{
    ...
    {
        /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor.manipulateAttachTransform"/>.</summary>
        ...
        /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor.rotateReferenceFrame"/>.</summary>
        ...
        /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor.rotateMode"/>.</summary>
