...
namespace UnityEngine.XR.Interaction.Toolkit.UI.BodyUI
{
    ...
    public class FollowPreset
    {
        ...
        public float PalmFacingUserHideMenuAngleThresholdDelta = 15f;
        ...
        public float PalmFacingUpHideMenuAngleThresholdDelta = 15f;
        ...
        /// </summary>
        [Tooltip("The additional threshold angle, in degrees, used as a buffer to hide the menu when the palm is facing the user.")]
        public float palmFacingUserHideMenuDotThreshold => m_PalmFacingUserHideMenuDotThreshold;
        ...
        /// </summary>
        public float palmFacingUpHideMenuDotThreshold => m_PalmFacingUpHideMenuDotThreshold;
