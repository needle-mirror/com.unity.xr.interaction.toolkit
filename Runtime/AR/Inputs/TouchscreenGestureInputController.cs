...
namespace UnityEngine.XR.Interaction.Toolkit.AR.Inputs
{
    ...
    public class TouchscreenGestureInputController : InputSystem.XR.XRController, IInputUpdateCallbackReceiver
    {
        ...
        /// </summary>
        internal TapGestureRecognizer tapGestureRecognizer { get; private set; }

        /// <summary>
        /// (Read Only) The Drag gesture recognizer.
        /// </summary>
        internal DragGestureRecognizer dragGestureRecognizer { get; private set; }

        /// <summary>
        /// (Read Only) The Pinch gesture recognizer.
        /// </summary>
        internal PinchGestureRecognizer pinchGestureRecognizer { get; private set; }

        /// <summary>
        /// (Read Only) The Twist gesture recognizer.
        /// </summary>
        internal TwistGestureRecognizer twistGestureRecognizer { get; private set; }

        /// <summary>
        /// (Read Only) The two-finger Drag gesture recognizer.
        /// </summary>
        internal TwoFingerDragGestureRecognizer twoFingerDragGestureRecognizer { get; private set; }
